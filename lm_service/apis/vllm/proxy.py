...
class Proxy(EngineClient):
    ...
    async def _run_output_handler(self) -> None:
        ...
        decoder_map = {
            ...
            RequestType.EXIT: exit_decoder,
            RequestType.START_PROFILE: profile_decoder,
            RequestType.STOP_PROFILE: profile_decoder,
